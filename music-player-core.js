// Music Player Core
// Create music-player-core.js with audio controls, playlist management, and song info display. Include methods for play(), pause(), next(), previous(), and updatePlaylist()
